...
DEFAULT_ROS_ENV_CWD="/home/cr4a/workspaces/ros_env/X5_ws"
DEFAULT_ROS_SETUP_SCRIPT="/home/cr4a/workspaces/ros_env/X5_ws/devel/setup.bash"
...
usage() {
  cat <<'EOF'
Usage: ./scripts/robots/robot-cr4a.sh [--env <test|prod>] [--mode <bilateral|vr>]
...
main() {
  ...
  require_file "/home/cr4a/workspaces/percept-edge/ontology-core/robot_os.pyz"
